-- CRITICAL: Complete database reset and schema reload
-- This script will ensure all tables exist and force a complete schema cache refresh
...
-- Force PostgREST schema cache reload multiple times to ensure it takes effect
